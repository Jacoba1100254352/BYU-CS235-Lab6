...
template <typename T>
void parse_instruction(const std::string& temp, std::ofstream &ofs, LinkedList<T>* LLptr);
...
int main() {
	...
	LinkedList<int>* iLL = nullptr;//the integer linked list
	LinkedList<string>* sLL = nullptr;//the string linked list
